...
<!--       <div class="col col-6">
 ...
 -->
    ...
    <!-- GROUP 18 STUB USE CASE 2: Identifying Inactive Repos  -->
    <!--
      Here there will be a Vue Component that displays the days since the last commit
      to the repo and the days until the repo will be considered inactive. The component
      will have different states based on how long it has been since the last commit (active,
      somewhat active, somewhat inactive, inactive). The component will receive the necessary
      information from the controller and display it in a visually appealing manner.
    -->
