<template>
  <section>
    ...
    <div style="display: inline-block;">
      ...
      <!-- GROUP 18 STUB USE CASE 1: Determining Openness of the repo -->
      <!-- This will be a vue component that will display the openness ratio
           of the repo. This will be measured by the number of
           pull requests merged divided by the number of pull requests
           proposed. The component will receive this information from the
           backend and display it in a visually appealing fashion on the front end
      -->
      <div class="col col-6">
