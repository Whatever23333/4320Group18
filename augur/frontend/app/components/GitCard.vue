<template>
  <section>
    ...
    <!-- GROUP 18 STUB USE CASE 3: Identifying top contributors to repo by commit -->
    <!--
      This will be a Vue Component that displays a list of the top contributors to a repo
      by commit. It will receive this information from the backend and display it in a
      visually appealing manner to the user. The list will be of the format:
      User  |   Commits
      x     |   49
      y     |   32
      z     |   17
